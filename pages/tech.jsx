...
const tech = () => {
  const data = [
    ...
    },
    {
      title: "Visual Studio",
      id: 1,
      main: "/icons/vscode.svg",
      desc: "stands out as the ultimate coding IDE with unparalleled customization options, integrating advanced tools for editing, debugging, and collaborative development.",
      tag: "code",
      bg: "bg-yellow-50",
    ...
    },
    {
      ...
      id: 2,
      main: "/icons/c.svg",
      desc: "C# is favored for its developer-friendly syntax, robustness, and extensive ecosystem, making it a preferred choice for building enterprise-level applications and services.",
      tag: "develop",
      bg: "bg-blue-50",
      text: "text-blue-500",
    },
    {
      ...
      desc: "High-level, versatile, and renowned for simplicity in web development, data analysis, AI, and scientific computing.",
      tag: "develop",
      bg: "bg-blue-50",
      text: "text-blue-500",
    },
    {
      title: "SQL Database",
      id: 4,
      main: "/icons/sqldatabase.svg",
      desc: "Standard language for managing relational databases like MySQL, PostgreSQL, SQL Server, and others.",
      tag: "database",
      bg: "bg-gray-900",
      text: "text-gray-50",
    },
    {
      ...
      id: 5,
      main: "/icons/java.svg",
      desc: "widely-used programming language known for its platform independence, robustness, and versatility in developing everything from enterprise applications to mobile apps and web services",
      tag: "develop",
      bg: "bg-green-50",
      text: "text-green-500",
    },
  
    {
      ...
      id: 6,
      main: "/icons/android.svg",
      desc: "official integrated development environment (IDE) for Android app development, equipped with powerful tools and resources for building, testing, and debugging Android applications.",
      tag: "develop",
      bg: "bg-pink-300",
      text: "text-pink-800",
    },
  ...
  return (
    <div className="min-h-[75vh] md:min-h-[73vh] px-10 sm:px-20 md:px-32 lg:mb-12 lg:px-60 xl:px-80 mx-auto">
      <Head>
        <title>Maverick Cagne | Skills</title>

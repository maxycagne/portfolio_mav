...
import HeroBlack from "@/public/mav-black.png";
import HeroWhite from "@/public/mav-white.png";
...
export default function About() {
  ...
  return (
    <div className="px-10 sm:px-20 md:px-32 lg:mb-12 lg:px-60 mx-auto max-w-[75rem]">
      <Head>
        <title>Maverick Cagne | About</title>
        ...
        <div className=" mx-auto pt-16 -pb-10 max-w-7xl">
          <div className=" mx-auto flex flex-col ">
            ...
            <p className="mt-8 max-w-xl text-center md:w-[70%] mx-auto text-sm md:text-base lg:text-xl mb-2 px-2">
              Currently a Third year College BSIT Student in STI College Tarlac
            </p>
          ...
          <div className=" text-[0.92rem] text-base mx-12 font-light dark:text-white text-gray-900">
            ...
            <p className="text-blue-700 select-none font-bold mb-1 dark:text-blue-700 ">
              Contact
            </p>
            <p className="">
              ...
              <a
                onClick={() =>
                  navigator.clipboard.writeText("maverickcagne@gmail.com")
                }
                ...
                href="maverickcagne@gmail.com"
              >
                {" "}
                maverickcagne@gmail.com
              </a>{" "}
